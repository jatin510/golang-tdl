...
func TestComponent(t *testing.T) {
	...
	canceledTicket := TicketStatus{
		TicketID: ticket.TicketID,
		Status:   "canceled",
		Email:    ticket.Email,
	}

	sendTicketsStatus(t, TicketsStatusRequest{Tickets: []TicketStatus{canceledTicket}})
...
func assertRowToSheetAdded(t *testing.T, spreadsheetsService *api.SpreadsheetsMock, ticket TicketStatus, sheetName string) {
	assert.EventuallyWithT(
		t,
		func(collectT *assert.CollectT) {
